...
- `createRateLimiter`: the underlying core, an injected ioredis client with in-memory insurance/fallback and a steady window composed with an optional burst allowance. Configuration is fixed at creation.
